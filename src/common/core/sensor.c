...
#ifdef debug
		logPrintf("Self Test Finish\r\n");
		HAL_Delay(100); // for stability

		logPrintf(" x-axis self test: acceleration trim within : %f percent of factory value\r\n",SelfTest[0]);
		HAL_Delay(100); // for stability
		logPrintf(" y-axis self test: acceleration trim within : %f percent of factory value\r\n",SelfTest[1]);
		HAL_Delay(100); // for stability
		logPrintf(" z-axis self test: acceleration trim within : %f percent of factory value\r\n",SelfTest[2]);
		HAL_Delay(100); // for stability

		logPrintf(" x-axis self test: gyration trim within : %f percent of factory value\r\n",SelfTest[3]);
		HAL_Delay(100); // for stability
		logPrintf(" y-axis self test: gyration trim within : %f percent of factory value\r\n",SelfTest[4]);
		HAL_Delay(100); // for stability
...
#ifdef debug
		logPrintf("Calibration Finish\r\n");
		HAL_Delay(100); // for stability
		logPrintf("   x       y      z\r\n");
		HAL_Delay(100); // for stability
		logPrintf(" %.2f   %.2f   %.2f mg\r\n", 1000*accBias[0], 1000*accBias[1], 1000*accBias[2]);
		HAL_Delay(100); // for stability
