...
const gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
  {
    ...
    {GPIOC, GPIO_PIN_3,  _DEF_OUTPUT,          GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},     // 3. PINIO
    {GPIOA, GPIO_PIN_15, _DEF_OUTPUT,          GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_HIGH},    // 4. SDCARD CS
    };
